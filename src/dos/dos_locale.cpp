...
// XXX move the resources to a separate file
...
static const std::map<uint16_t, DosCountry> CodeToCountryCorrectionMap = {
...
static const std::map<DosCountry, CountryInfo> CountryData = {
	// clang-format off
...
{
	DOS_DetectHostLocale(); // XXX just for testing
